...
import com.bookstore.bookstore_app.entity.OrderItem;
...
public class VendorService {
    ...
    private BigDecimal calculateTotalRevenue(Long vendorId) {
        // This would require joining with order items - simplified for now
        return BigDecimal.ZERO;
    }

    private int getTotalOrdersCount(Long vendorId) {
        // This would require counting orders containing vendor's books - simplified for now
        return 0;
    }
}